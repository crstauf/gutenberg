 ...
 * @return {import('react').JSX.Element} The popover content.
 */
 ...
 *
 * @param {Object}                      props            Component props.
 * @param {import('react').JSX.Element} props.icon       The icon element to display.
 * @param {Array}                       props.clientIds  The client IDs of selected blocks.
 * @param {string}                      props.blockTitle The display title of the block.
 * @param {string}                      props.label      The label for the button.
 * @return {import('react').JSX.Element} The pattern overrides button component.
 */
