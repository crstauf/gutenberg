...
type Story = StoryObj< typeof FontSizePicker >;
 ...
 */
export const WithCustomSizesDisabled: Story = {
	render: FontSizePickerWithState,
	args: {
		...Default.args,
 ...
 */
export const WithMoreFontSizes: Story = {
	render: FontSizePickerWithState,
	args: {
		...Default.args,
		fontSizes: [
 ...
 */
export const WithComplexCSSValues: Story = {
	render: TwoFontSizePickersWithState,
	args: {
		...Default.args,
		fontSizes: [
